...
# AbacatePay Integration (Production Keys)
ABACATEPAY_API_KEY=abc_prod_...
ABACATEPAY_WEBHOOK_SECRET=whsec_...
```

> **Atenção:** Veja o [Guia de Configuração do AbacatePay](docs/abacate-pay/SETUP.md) para detalhes de como gerar as chaves e configurar o Webhook na plataforma.
